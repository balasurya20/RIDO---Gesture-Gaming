...
def DriverGame():
    # Game initialization
    pygame.init()
    pygame.mixer.init()  # For loading sound
    ...
    # Game sounds
    GAME_SOUNDS['die'] = load_sound('audio/die.wav')
    GAME_SOUNDS['hit'] = load_sound('audio/hit.wav')
    GAME_SOUNDS['point'] = load_sound('audio/point.wav')
    GAME_SOUNDS['swoosh'] = load_sound('audio/swoosh.wav')
    GAME_SOUNDS['wing'] = load_sound('audio/wing.wav')
